...
CLIBS		:= -l clibs
CLIBS_INC	:= -I /usr/local/include/clibs

DEVELOPMENT	:= -g -D ORION_DEBUG
...
LIB         := -L /usr/local/lib $(PTHREAD) $(MATH) $(OPENSSL) $(MONGOC) $(CLIBS) $(CMONGO)
INC         := -I $(INCDIR) -I /usr/local/include $(MONGOC_INC) $(CLIBS_INC) $(CMONGO_INC)
INCDEP      := -I $(INCDIR)
